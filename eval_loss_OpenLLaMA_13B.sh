...
LOAD_CHECKPOINT_PATH=/mnt/data/smart_health_02/xuekui/pretrain_weights/nlp/OpenLLaMA-13B-megatron-states

DATA_OUTPUT_PATH=./model_dir/OpenLLaMA_13B_zh_eval
...
DATA_PATH="/mnt/data/smart_health_02/xuekui/dataset/pretrain_data/OpenLLaMA-13B-zh/lm_zh-cn_wikipedia_text_document"
...
config_json="./ds_config.$SLURM_JOB_ID.eval.json"

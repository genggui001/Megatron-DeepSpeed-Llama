...
LOAD_CHECKPOINT_PATH=/mnt/data/smart_health_02/xuekui/pretrain_weights/nlp/pulse-7Bv8-megatron-states

DATA_OUTPUT_PATH=./model_dir/baichuan_7b_0731
...
DATA_PATH="/mnt/data/smart_health_02/xuekui/code/Megatron-DeepSpeed-Llama/dataset/"
...
GPT_ARGS=" \
    --pp-partition-method 'parameters' \
    --num-layers $NLAYERS \
    --hidden-size $NHIDDEN \
...
export CMD=" \
    finetune_pulse_7bv8_use_dataset.py \

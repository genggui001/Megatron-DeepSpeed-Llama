...
LOAD_CHECKPOINT_PATH=/mnt/data/smart_health_02/xuekui/pretrain_weights/nlp/baichuan-7B-hf-megatron-states
...
DATA_PATH="/mnt/data/smart_health_02/xuekui/dataset/pretrain_data/baichuan/lm_zh-cn_wikipedia_text_document"

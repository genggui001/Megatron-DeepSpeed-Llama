...
LOAD_CHECKPOINT_PATH=/mnt/data/smart_health_02/xuekui/pretrain_weights/nlp/chinese-llama-plus-13b-megatron-states

DATA_OUTPUT_PATH=./model_dir/llama_13b_zh_eval
